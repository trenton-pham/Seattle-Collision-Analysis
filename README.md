...
- When modeling, an equal qcut into thirds is used when labeling risk values for each zone (low, medium, high); however, this isn't representative of the true severity of the collision, and I will be soon working to refine my approach on labeling risk values.
- I'm lowk a lil slow...
